...
public class PathADecideRedBlueCommand extends CommandBase {
   ...
   */
  public PathADecideRedBlueCommand(CommandGroupBase blue, CommandGroupBase red, VisionSubsystem visionSubsystem) {
    m_blue = blue;
    m_red = red;
